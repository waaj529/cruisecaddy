        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-brand-mint rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-brand-teal transition-colors duration-300 group">
                  <MapPin className="h-4 w-4 text-brand-teal group-hover:text-white transition-colors duration-300" />
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-brand-mint rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-brand-teal transition-colors duration-300 group">
                  <Phone className="h-4 w-4 text-brand-teal group-hover:text-white transition-colors duration-300" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-brand-teal mb-2">
                    Contact Information
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-brand-mint rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-brand-teal transition-colors duration-300 group">
                  <Clock className="h-4 w-4 text-brand-teal group-hover:text-white transition-colors duration-300" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-brand-teal mb-2">
                    Tour Schedule
          ...
          <div className="relative">
            <div className="relative aspect-square rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                ...
                src="https://www.google.com/maps/place/946+Siesta+Dr,+Sarasota,+FL+34242/@27.3025488,-82.5498857,17z/data=!3m1!4b1!4m6!3m5!1s0x88c341cce9ffbfef:0xa56f94aed425f897!8m2!3d27.3022766!4d-82.5474124!16s%2Fg%2F11bw4h3y4f?entry=ttu&g_ep=EgoyMDI1MDgxMi4wIKXMDSoASAFQAw%3D%3D"
                loading="lazy"
